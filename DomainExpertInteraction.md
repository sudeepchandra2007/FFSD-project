...
Domain:   Health and Wellness platforms
...
### Key Domain Terms :
   ...
   | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
   | Wellness Program | A wellness program is a structured set of activities designed to improve employee's physical and mental well-being.                |
   | Consultation     | Consultation refers to a one-to-one interaction between an employee and a wellness expert for health guidance.                     |
